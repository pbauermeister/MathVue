...
function FileDialog(ending) {
  ...
  this.thumbnailHandler = function (id, dataUrl) {
    ...
    if (elem) elem.setAttribute("src", dataUrl);
  };
  ...
  this.openFile = function (entries, onItemSelected, storageManager) {
    ...
    var dlg = BootstrapDialog.show({
      ...
      message:
        '<div id="fileDialog" class="dialog-file-load-list">' +
        "         <div v-cloak>" +
      ...
      onshow: function () {
        ...
        setTimeout(function () {
          ...
          makeFileDialogVue(
            ...
            null,
            function () {
              storageManager.thumbnailsLoader(
                entries,
                that.ending,
                that.thumbnailHandler
              );
            },
            function (entry, app) {
              dlg.close();
  ...
  this.saveFile = function (
    ...
    var checkChange = function (name) {
      ...
      if (exists) button.html("Overwrite");
      else button.html("Save");
